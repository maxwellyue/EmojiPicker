...
/// Pre-defined emoji data for all categories.
/// This enum contains all emoji definitions organized by category.
enum EmojiDefinitions {
    static let peopleEmojis: EmojiCategory = .init(
        type: .people,
        emojis: [
            Emoji(
                emojiKeys: [0x1F600],
    ...
    static let natureEmojis: EmojiCategory = .init(
        type: .nature,
        emojis: [
            Emoji(
                emojiKeys: [0x1F435],
    ...
    static let foodAndDrinkEmojis: EmojiCategory = .init(
        type: .foodAndDrink,
        emojis: [
            Emoji(
                emojiKeys: [0x1F347],
    ...
    static let activityEmojis: EmojiCategory = .init(
        type: .activity,
        emojis: [
            Emoji(
                emojiKeys: [0x1F383],
    ...
    static let travelAndPlacesEmojis: EmojiCategory = .init(
    ...
    static let objectEmojis: EmojiCategory = .init(
        type: .objects,
        emojis: [
            Emoji(
                emojiKeys: [0x1F453],
    ...
    static let symbolEmojis: EmojiCategory = .init(
        type: .symbols,
        emojis: [
            Emoji(
                emojiKeys: [0x1F3E7],
    ...
    static let flagEmojis: EmojiCategory = .init(
        type: .flags,
        emojis: [
            Emoji(
                emojiKeys: [0x1F3C1],
